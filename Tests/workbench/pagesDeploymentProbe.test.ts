...
const EXPECTED_MAIN_SHA = '88c82f27112d953cd04cfffb43257cbd7852a6cf';

describe('temporary Pages deployment probe', () => {
  it('serves the exact expected main commit in the deployed Workbench bundle', async () => {
