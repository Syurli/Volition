...
export const tacticalWizardTestMap = {
  ...
  height: 40,
  blocked: [
    // Original V3/V6 training geometry (kept intact for familiar regression scenarios).
    ...
    // East-side divider. Three deliberate gates connect the old yard to the new compound.
    ...rect(49, 0, 1, 6), ...rect(49, 9, 1, 9), ...rect(49, 21, 1, 10), ...rect(49, 34, 1, 6),

    // CQB block: perimeter segments + offset internal walls. Openings are intentional doorways.
    ...
    // Alley network: staggered walls create corners, offset sightlines and alternate approaches.
    ...
    // South courtyard / search compound. Broken perimeter gives several entry and block-exit options.
    ...
    // South-west sparse cover extends the original yard with longer open movement tests.
  ...
  testPoints: [
    ...
    { id: 'cqb-door', name: 'CQB Door', nameZh: 'CQB 门口', hint: 'Short-range doorway contact; useful for close-pressure and buddy movement.', hintZh: '短距离门口接敌，用于近战机会与 Buddy 互相掩护。', position: { x: 53, y: 7 } },
