...
const messages = {
  'zh-CN': {
    ...
    exampleDescription: '官方内置战术巫师步枪小队示例：编队巡逻、感知与共享警报、交替掩护、绕后、换人、协同猛攻、重新编组与失联搜索。',
    localDescription: '项目数据保存在本机浏览器，并可导入/导出为 Volition 项目 JSON。',
    simulationDescription: 'Volition 决定高层认知与战术意图；Workbench Simulation Host 负责 A*、LOS、掩体/侧翼位置查询、移动与表现。',
  ...
  'en-US': {
    ...
    exampleDescription: 'Bundled Tactical Wizard rifle-squad example: formation patrol, perception and shared alert, bounding overwatch, flanking, role rotation, coordinated assault, regrouping, and target-loss search.',
    localDescription: 'Project data stays on this machine and can be imported/exported as Volition project JSON.',
    simulationDescription: 'Volition owns high-level cognition and tactical intent; the Workbench Simulation Host owns A*, LOS, cover/flank position queries, movement, and presentation.',
